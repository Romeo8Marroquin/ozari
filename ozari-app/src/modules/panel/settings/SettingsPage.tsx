...
// The on-brand keyboard focus indicator, matching the rest of the panel chrome.
const FOCUS_RING =
...
// A neutral secondary button (used for the security actions). Disabled while its phase is pending.
const SECONDARY_BUTTON = `inline-flex items-center justify-center rounded-control border border-charcoal/15 bg-white px-3.5 py-1.5 text-sm font-medium text-charcoal/80 transition-colors hover:bg-charcoal/[0.04] disabled:cursor-not-allowed disabled:opacity-45 ${FOCUS_RING}`;
      ...
      >
        <div className="divide-y divide-charcoal/[0.06]">
          <SecurityRow
            ...
            action={
              <button type="button" disabled title={t('modules.panel.settings.soon')} className={SECONDARY_BUTTON}>
